...
namespace SerializationTestGenerator
{
    class Program
    {
        ...
        IEnumerable<string> BuildTestMethods()
        {
            ...
            yield return "";
            yield return "namespace Uavcan.NET.Dsdl.Testing.Serialization.AutogeneratedTests";
            yield return "{";
...
print(''.join('{{:02x}}'.format(x) for x in payload))";
        ...
        void BuildTypes(string typesPath)
        {
            ...
            builder.AppendLine();
            builder.AppendLine("namespace Uavcan.NET.Dsdl.Testing.Serialization.AutogeneratedTests");
            builder.AppendLine("{");
