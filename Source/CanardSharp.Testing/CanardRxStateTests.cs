...
namespace CanardSharp.Testing
{
    [TestClass]
    public class CanardRxStateTests
    {
        [TestMethod]
        public void CanardRxStateTest0()
        {
            var state = new CanardRxState();
        ...
        static void AddFrames(CanardRxState state, string hex)
        {
        ...
        static void AddFrame(CanardRxState state, string hex)
        {
